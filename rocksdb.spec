...
Source0  : https://github.com/facebook/rocksdb/archive/rocksdb-5.3.6.tar.gz
...
%prep
%setup -q -n rocksdb-rocksdb-5.3.6
%patch1 -p1
%patch2 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1495818557
