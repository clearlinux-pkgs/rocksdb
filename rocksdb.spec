...
Source0  : https://github.com/facebook/rocksdb/archive/rocksdb-5.4.6.tar.gz
...
%prep
%setup -q -n rocksdb-rocksdb-5.4.6
%patch1 -p1
%patch2 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1496411105
...
/usr/lib64/librocksdb.so.5.4
/usr/lib64/librocksdb.so.5.4.6
